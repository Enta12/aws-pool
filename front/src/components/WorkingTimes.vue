      ...
      <v-list class="listCard">
        <template>
          <v-expansion-panels focusable multiple>
            <v-expansion-panel v-for="(item, i) in 12" :key="i" v-model="panel">
              ...
              <v-expansion-panel-content class="justify-center">
                <v-expansion-panel v-for="(item, itm) in 7" :key="itm" multiple>
